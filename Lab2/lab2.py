...
def inf(count, mean):
    ...
    array_aij = []
    for i in range(3):
        # Запис на 1 рядок матриці планування, номованих значень X1 та X2
        if i == 0:
            matr_x.append([-1, -1])
            matr_x2.append([min(array_x1), min(array_x2)])
        # Запис на 2 рядок матриці планування, номованих значень X1 та X2
        elif i == 1:
            matr_x.append([-1, 1])
            matr_x2.append([min(array_x1), max(array_x2)])
        # Запис на 3 рядок матриці планування, номованих значень X1 та X2
        elif i == 2:
            matr_x.append([1, -1])
